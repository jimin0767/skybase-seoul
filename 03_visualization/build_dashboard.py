...
map.on('load', () => {{
  ...
  map.addLayer({{
    ...
    minzoom: 12,
    paint: {{
      // Distinct blue-gray palette that contrasts against the dark basemap.
      // Lighter shades for taller buildings so height reads clearly.
      ...
      // Disable gradient: prevents wall faces from getting terrain-like slope shading
      // that makes adjacent buildings blur into a hill surface.
